...
struct HardwareMapping matrix_hardware_mappings[] = {
   ...
   */
  {
    ...
    .c             = GPIO_BIT(24),
    .d             = GPIO_BIT(1),
    .e             = GPIO_BIT(25),  // GPIO_BIT(15),  /* RxD kept free unless 1:64 */

    /* Parallel chain 0, RGB for both sub-panels */
    .p0_r1         = GPIO_BIT(12),  /* masks: SPI0_SCKL  */
    .p0_g1         = GPIO_BIT(5),  /* Not on RPi1, Rev1; use "regular-pi1" instead */
    .p0_b1         = GPIO_BIT(6),   /* masks: SPI0_CE1   */
    .p0_r2         = GPIO_BIT(19),   /* masks: SPI0_CE0   */
    .p0_g2         = GPIO_BIT(13),   /* masks: SPI0_MISO  */
    .p0_b2         = GPIO_BIT(20),  /* masks: SPI0_MOSI  */
